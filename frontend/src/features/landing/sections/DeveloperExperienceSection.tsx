      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        >
          <GlowCard className="h-full">
            <p className="text-xs uppercase tracking-[0.2em] text-fg-muted">Startup lifecycle</p>
            <div className="mt-5 space-y-3 text-sm text-fg">
              <div className="ef-card ef-card-soft rounded-lg border border-border-subtle bg-surface p-3">
        ...
        >
          <GlowCard className="h-full">
            <p className="text-xs uppercase tracking-[0.2em] text-fg-muted">Execution visibility</p>
            <div className="mt-5 space-y-4 text-sm text-fg">
              <div className="ef-card ef-card-soft flex items-center justify-between rounded-lg border border-border-subtle bg-surface p-3">
